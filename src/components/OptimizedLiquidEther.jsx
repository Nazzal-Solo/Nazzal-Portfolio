...
export default function OptimizedLiquidEther({
  mouseForce = 15,
  cursorSize = 80,
  isViscous = false,
  viscous = 20,
  ...
  dt = 0.016,
  BFECC = true,
  resolution = 0.3, // Reduced from 0.5 for better performance
  isBounce = false,
  colors = ["#5227FF", "#FF9FFC", "#B19EEF"],
  style = {},
  className = "",
  autoDemo = true,
  autoSpeed = 0.3, // Reduced speed for smoother performance
  autoIntensity = 1.5, // Reduced intensity
  takeoverDuration = 0.25,
  autoResumeDelay = 2000, // Reduced delay
  autoRampDuration = 0.4, // Reduced duration
}) {
  ...
  useEffect(() => {
    ...
    class CommonClass {
      constructor() {
        ...
        this.height = 0;
        this.aspect = 1;
        this.pixelRatio = Math.min(window.devicePixelRatio || 1, 1.5); // Reduced pixel ratio
        this.isMobile = false;
        this.breakpoint = 768;
        this.fboWidth = null;
        this.fboHeight = null;
    ...
    // Shader code (same as original but optimized)
    const face_vert = `
...
`;
    ...
    class Simulation {
      constructor(options) {
        this.options = {
          iterations_poisson: 16, // Reduced from 32
          iterations_viscous: 16, // Reduced from 32
          mouse_force: 15, // Reduced from 20
          resolution: 0.3, // Reduced from 0.5
          cursor_size: 80, // Reduced from 100
          viscous: 20, // Reduced from 30
          isBounce: false,
          dt: 0.016, // Reduced from 0.014
          isViscous: false,
          BFECC: true,
          ...options,
        };
