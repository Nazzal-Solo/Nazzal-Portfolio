...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    // Memoized palette texture creation for better performance
    const makePaletteTexture = useCallback((stops) => {
      let arr;
      ...
      dispose() {
        try {
          ...
          if (this.output && this.output.simulation) {
            ...
            Object.keys(sim.fbos).forEach((key) => {
              if (sim.fbos[key]) {
                sim.fbos[key].dispose();
              }
            });
          }
        } catch (e) {
